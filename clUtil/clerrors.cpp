...
#endif
#ifdef CL_UNKNOWN_ERROR
	case CL_UNKNOWN_ERROR:                                      return "CL_UNKNOWN_ERROR";
#endif
...
std::string cl::getOpenCLErrorDescription(cl_int err) {
	switch (err) {
        ...
        case CL_INVALID_OPERATION:                              return "invalid operation specified";
        ...
        case CL_INVALID_MIP_LEVEL:                              return "invalid MIP level specefied";
...
#endif
#ifdef CL_INVALID_DEVICE_QUEUE
        case CL_INVALID_DEVICE_QUEUE:                           return "not a valid device queue object, when an argument is of type queue_t when it’s not a valid device queue object. returned by clSetKernelArg";
#endif
#ifdef CL_INVALID_SPEC_ID
...
#ifdef CL_INVALID_GL_SHAREGROUP_REFERENCE_KHR
		case CL_INVALID_GL_SHAREGROUP_REFERENCE_KHR:            return "CL and GL not on the same device (only when using a GPU). returned by (clGetGLContextInfoKHR, clCreateContext)";
#endif
#ifdef CL_PLATFORM_NOT_FOUND_KHR
		case CL_PLATFORM_NOT_FOUND_KHR:                         return "No valid ICDs found, returned by clGetPlatform";
#endif
#ifdef CL_INVALID_D3D10_DEVICE_KHR
		case CL_INVALID_D3D10_DEVICE_KHR:                       return "not a compatible Direct3D 10 device, if the Direct3D 10 device specified for interoperability is not compatible with the devices against which the context is to be created. returned by (clCreateContext, clCreateContextFromType)";
#endif
#ifdef CL_INVALID_D3D10_RESOURCE_KHR
		case CL_INVALID_D3D10_RESOURCE_KHR:                     return "not a Direct3D 10 buffer or texture object";
#endif
#ifdef CL_D3D10_RESOURCE_ALREADY_ACQUIRED_KHR
		case CL_D3D10_RESOURCE_ALREADY_ACQUIRED_KHR:            return "mem_object is already acquired by OpenCL, returned by clEnqueueAcquireD3D10ObjectsKHR";
#endif
#ifdef CL_D3D10_RESOURCE_NOT_ACQUIRED_KHR
		case CL_D3D10_RESOURCE_NOT_ACQUIRED_KHR:                return "mem_object is not acquired by OpenCL, returned by clEnqueueReleaseD3D10ObjectsKHR";
#endif
#ifdef CL_UNKNOWN_ERROR
		case CL_UNKNOWN_ERROR:                                  return "CL_UNKNOWN_ERROR";
#endif
