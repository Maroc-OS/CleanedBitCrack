...
__constant unsigned int _IV[8] = {0x6a09e667, 0xbb67ae85, 0x3c6ef372,
...
#define roundSha256(a, b, c, d, e, f, g, h, m, k)                                \
  t = CH((e), (f), (g)) + (rotr((e), 6) ^ rotr((e), 11) ^ rotr((e), 25)) + \
      (k) + (m);                                                           \
  (d) += (t) + (h);                                                        \
  (h) += (t) + MAJ((a), (b), (c)) +                                        \
         (rotr((a), 2) ^ rotr((a), 13) ^ rotr((a), 22))

void sha256PublicKey(const unsigned int x[8], const unsigned int y[8],
...
void sha256PublicKeyCompressed(const unsigned int x[8], unsigned int yParity,
    ...
    // 0x03 || x  or  0x02 || x
    w[0] = 0x02000000 | ((yParity & 1u) << 24u) | (x[0] >> 8u);
